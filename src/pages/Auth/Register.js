...
const Register = (props) => {
    ...
    document.title = "Register | VetConnect"
                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                                ...
                                <CardBody className="p-4">
                                    ...
                                    >
                                        ...
                                        <div className="mt-4 text-center">
                                            <p className="text-muted mb-0">{t('By registering you agree to the VetConnect')} <Link to="#" className="text-primary">{t('Terms of Use')}</Link></p>
                                        </div>
                            ...
                            <div className="mt-5 text-center">
                                ...
                                <p>© {new Date().getFullYear()} {t('VetConnect')}. {t('Created with')} <i className="mdi mdi-heart text-danger"></i> {t('by Montissol Essentials LLC')}</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
