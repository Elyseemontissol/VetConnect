...
const Login = (props) => {
    ...
    document.title = "Login | VetConnect";
                        ...
                        <Col md={8} lg={6} xl={5} >
                            <div className="text-center mb-4">
                                <Link to="/" className="auth-logo mb-5 d-block">
                                    <img src={logodark} alt="" height="100" className="logo logo-dark" />
                                    <img src={logolight} alt="" height="100" className="logo logo-light" />
                                </Link>

                                <h4>{t('Sign in')}</h4>
                                <p className="text-black mb-4">{t('Sign in to continue to VetConnect')}.</p>
